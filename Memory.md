...
### Unterordner `Forma/` (Stand 12.07.2026)
...
| `appletouchicon.png`, `favicon16.png`, `favicon32.png`, `icon192.png`, `icon512.png`, `icon512maskable.png`, `formalogo.png`, `forma_icon_variante_15.png` | App-Icons (Forma-Logo Entwurf 15), flach im Ordner. Namen bewusst ohne Bindestrich (siehe Log 12.07.) |
...
| `ChatGPT Image ...21_00_13.png` | Logo-Quellbild (11.07.) |
